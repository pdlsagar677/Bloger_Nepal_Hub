        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              A vibrant community of writers and readers sharing stories, ideas, and inspiration. 
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.198-1.558a4.16 4.16 0 01-.84-2.439c0-1.297.611-2.448 1.558-3.198a4.16 4.16 0 012.439-.84c1.297 0 2.448.611 3.198 1.558a4.16 4.16 0 01.84 2.439c0 1.297-.611 2.448-1.558 3.198a4.16 4.16 0 01-2.439.84zm7.144 0c-1.297 0-2.448-.611-3.198-1.558a4.16 4.16 0 01-.84-2.439c0-1.297.611-2.448 1.558-3.198a4.16 4.16 0 012.439-.84c1.297 0 2.448.611 3.198 1.558a4.16 4.16 0 01.84 2.439c0 1.297-.611 2.448-1.558 3.198a4.16 4.16 0 01-2.439.84z" clipRule="evenodd"/>
                </svg>
              </a>
            </div>
          </div>
